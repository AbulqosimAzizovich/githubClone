            ...
            <div className="sidebar">
                <div className="sidebar__content">
                    <div className='sidebar__content--section'>
                        <img src={array.avatar_url} alt="me" className="sidebar__content-img" />
                    ...
                    <ul className="sidebar__content--list">
                        <li className="sidebar__content--list--item">
                            <span className='sidebar__content--list--item-icon' > <i className="bi bi-people"></i> </span>
                            <NavLink className='sidebar__content--list--item-link' to="/followers">{array.followers} followers</NavLink>
                        </li>
                        <li className="sidebar__content--list--item">
                            <NavLink className='sidebar__content--list--item-link' to="/following">{array.following} following</NavLink>
                        </li>
                    </ul>
                </div>
            </div>
